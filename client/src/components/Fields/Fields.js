...
const Fields = ({ fadeIn, categoryText }) => {
  ...
  const proOptions = [
    ...
    `Good ${fields.fieldsAttributes.UNIQUE_TIME} ${fields.fieldsAttributes.UNIQUE_PERSON}, \n\nUnfortunately I will not be able to make it class on ${fields.fieldsAttributes.UNIQUE_DATE} and I must request an absence. Please let me know if this will be an issue.\n\nBest Regards,\n${fields.fieldsAttributes.fullName}`,
