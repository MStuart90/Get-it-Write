                            ...
                            <Collapse isOpen={isOpen9}>
                              <FormGroup>
                                ...
                                >
                                  ...
                                  <option value="casualOption4-1">
                                    Misc 1
                                  </option>
                                  <option value="casualOption4-2">
                                    Misc 2
                                  </option>
                                  <option value="casualOption4-3">
                                    Misc 3
                                  </option>
                                  <option value="casualOption4-4">
                                    Misc 4
                                  </option>
                                  <option value="casualOption4-5">
                                    Misc 5
                                  </option>
                                </Input>
                              </FormGroup>
